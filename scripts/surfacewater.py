# surface water module of the pcrLite model
...
class surfacewater(object):
    ...
    """
    surfacewater: class that holds the surface water component of the pcrLite \
    model.
    ...
    def __str__(self):
        return 'this is the surface water module of the pcrLite model.'
    ...
    def get_total_runoff(self, \
        ...
        # this is the base flow over the entire area,
        # the direct runoff and interflow over the land area and the
